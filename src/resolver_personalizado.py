        ...
        if op == "<=":
            ...
            if a >= 0:
                ...
                e["resolucion"] = (
                    ...
                    f"Para $Z \\sim \\mathcal{{N}}(0, 1)$, cola superior derecha desde el valor negativo ${a:.2f}$.\n\n"
                    f"**Paso 2: Aplicación formal de la Regla del Complemento.**\n"
                    f"$$P(Z \\ge {a:.2f}) = 1 - P(Z \\le {a:.2f})$$\n\n"
                    f"**Paso 3: Aplicación de simetría en la cola inferior.**\n"
                    f"Por simetría: $P(Z \\le {a:.2f}) = 1 - P(Z \\le {pos_a:.2f})$.\n\n"
                    f"**Paso 4: Sustitución algebraica.**\n"
                    f"$$P(Z \\ge {a:.2f}) = 1 - [1 - P(Z \\le {pos_a:.2f})] = P(Z \\le {pos_a:.2f})$$\n\n"
                    ...
                    f"*(Nota sobre la gráfica: La región sombreada inicia en el punto negativo ${a:.2f}$ y se extiende hacia la derecha abarcando más del 50% de la curva).* "
                )
                e["region_type"] = "right"
                e["points"] = [a]
                e["labels"] = [f"z = {a:.2f}"]
